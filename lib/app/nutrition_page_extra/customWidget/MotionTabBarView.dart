...
class _TabStyle extends AnimatedWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final TextStyle defaultStyle = (labelStyle
        ...
        ?? themeData.primaryTextTheme.body1 // ignore: deprecated_member_use
    ...
    final Color selectedColor = labelColor
        ...
        ?? themeData.primaryTextTheme.body1.color; // ignore: deprecated_member_use
...
class MotionTabBarView extends StatefulWidget {
  ...
  ///
  /// For life_coach, determines how the page view continues to animate after the
