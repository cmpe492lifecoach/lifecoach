...
///
/// life_coach of [controller] usage, only listening for state changes:
///
/// ```
/// class _life_coachWidgetState extends State<life_coachWidget> {
///
...
/// ```
///
/// An life_coach of [scaleStateController] with state changes:
/// ```
/// class _life_coachWidgetState extends State<life_coachWidget> {
///
